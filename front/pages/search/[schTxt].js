...
const SearchResult = () => {
	...
	// useEffect(() => {
	// 	!console.log("searchMusicListLoading", !searchMusicListLoading);
	// 	console.log("inView", inView);
	// 	console.log("hasMoreBoardList", hasMoreBoardList);
	...
	return (
		<AppLayout>
			...
			<div
				ref={searchMusicList && !searchMusicListLoading ? ref : undefined}
