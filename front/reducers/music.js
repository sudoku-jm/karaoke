...
//요청 상세
export const BOARD_INFO_REQUEST = "BOARD_INFO_REQUEST";
export const BOARD_INFO_SUCCESS = "BOARD_INFO_SUCCESS ";
export const BOARD_INFO_FAILURE = "BOARD_INFO_FAILURE";
	...
	return produce(state, (d) => {
		...
		switch (action.type) {
			...
			case GET_BOARD_LIST_FAILURE:
				...
				break;
			//요청 상세 가져오기
			case BOARD_INFO_REQUEST:
				draft.boardInfoLoading = true;
				draft.boardInfoDone = false;
				break;
			case BOARD_INFO_SUCCESS:
				draft.boardInfoLoading = false;
				draft.boardInfoDone = true;
				draft.boardInfo = action.data;
				break;
			case BOARD_INFO_FAILURE:
				draft.boardInfoLoading = false;
				draft.boardInfoError = action.error;
				draft.boardInfo = null;
				break;
