...
router.get("/getCategoryList", async (req, res, next) => {
  try {
    ...
    console.log("/music/getCategoryList=================================[END]");
  } catch (error) {
    console.log(error);
    next(error);
  }
...
router.post("/searchCategory", async (req, res, next) => {
  try {
    ...
    console.log("/music/searchCategory=================================[END]");
  } catch (error) {
    console.log(error);
    next(error);
  }
...
router.get("/getSingerList", async (req, res, next) => {
  try {
    //카테고리 데이터 전달
    console.log("/music/getSingerList=================================[START]");
    ...
    console.log("/music/getSingerList=================================[END]");
  } catch (error) {
    console.log(error);
    next(error);
  }
...
router.post("/searchSinger", async (req, res, next) => {
  try {
    //카테고리 데이터 전달
    console.log("/music/searchSinger=================================[START]");
    ...
    console.log("/music/searchSinger=================================[END]");
  } catch (error) {
    console.log(error);
    next(error);
  }
...
router.post("/insertBoard", async (req, res, next) => {
  try {
    ...
    if (req.body.new == "N") {
      ...
      } else if (Object.keys(category).length !== 0 && category !== null) {
        //카테고리 값이 있을 때
        form.b_category = category.name;
      }
...
router.get("/getBoardList", async (req, res, next) => {
  try {
    //카테고리 데이터 전달
    console.log("/music/getBoardList=================================[START]");
    ...
    console.log("/music/getBoardList=================================[END]");
  } catch (error) {
    console.log(error);
    next(error);
  }
...
router.get("/searchHashTag", async (req, res, next) => {
  try {
    console.log("/music/searchHashTag=================================[START]");
    const searchStr = req.query.searchStr;
    let where = {};
    if (parseInt(req.query.lastId, 10)) {
      // 초기 로딩이 아닐 때
    ...
    console.log("/music/searchHashTag=================================[END]");
  } catch (error) {
    next(error);
  }
});
